...
class ConsultantProfileController extends Controller
{
    ...
    public function saveProfile(Request $request)
    {
        $validated = $request->validate([
            ...
            'expertise.*' => 'in:Business Strategy,Startup & Entrepreneurship,Marketing & Branding,Financial & Investment,Technology & IT Support,Legal Consultation,Human Resources (HR) Consultation,E-commerce & Online Business,Career & Professional Development,Healthcare & Wellness',
