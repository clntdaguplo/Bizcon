...
<div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="{{ route('dashboard.consultant') }}" class="mr-4 text-white/80 hover:text-white transition-colors">
    ...
    @else
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
            ...
            <a href="{{ route('dashboard.consultant') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
