...
<body class="bg-gray-100 text-gray-900">
    ...
    <main class="min-h-screen pt-32 px-6">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md">
            ...
            <p class="text-lg text-gray-700 mb-6">Hello, {{ Auth::user()->name }}! You're now verified and ready to help clients. Manage appointments, respond to inquiries, and grow your consulting business.</p>
