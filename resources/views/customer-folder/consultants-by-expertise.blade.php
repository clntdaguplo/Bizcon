...
<div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="{{ route('customer.dashboard') }}" class="mr-4 text-white/80 hover:text-white transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm">Top experts ready to help you</p>
                    </div>
                </div>
    ...
    @if($consultants->count() > 0)
        ...
        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl shadow-lg border border-amber-200 p-6">
            <div class="flex items-center mb-4">
                ...
                <h3 class="ml-3 text-lg font-bold text-amber-900">🏆 Top Recommended for {{ $decodedExpertise }}</h3>
            </div>
            <div class="flex items-center">
                <div class="relative">
                ...
                <div class="ml-6 flex-1">
                    ...
                    <div class="flex items-center gap-4 mt-2">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700">{{ $topConsultant->completed_count }} sessions completed</span>
                        </div>
                ...
                <a href="{{ route('customer.new-consult', ['consultant' => $topConsultant->id]) }}" 
                   class="px-5 py-2.5 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors font-medium shadow-md shadow-amber-200">
                    Book Now
                </a>
            </div>
        </div>
                ...
                @foreach($consultants as $index => $consultant)
                    <div class="p-5 hover:bg-gray-50 transition-colors group">
                        <div class="flex items-center">
                            ...
                            <div class="relative">
                                @if($consultant->avatar_path)
                                    <img src="{{ asset('storage/' . $consultant->avatar_path) }}" 
                                         ...
                                         class="w-14 h-14 rounded-full object-cover border-2 border-gray-200 group-hover:border-blue-300 transition-colors">
                                @else
                                    <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center border-2 border-gray-200 group-hover:border-blue-300 transition-colors">
                            ...
                            <!-- Actions -->
                            <div class="ml-4">
                                <a href="{{ route('customer.new-consult', ['consultant' => $consultant->id]) }}" 
                                   class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-sm hover:shadow">
                                    Book
    ...
    @else
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
            ...
            <p class="text-gray-500 mb-6">There are no verified experts in "{{ $decodedExpertise }}" available at the moment.</p>
            <a href="{{ route('customer.dashboard') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
