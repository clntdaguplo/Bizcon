...
@section('title', 'Rejected Consultants')
@section('page-title', 'Rejected Consultants')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Rejected Consultants</h2>
                <p class="text-gray-600">View and manage rejected consultant applications</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ $rejected->total() }}</p>
            </div>
        </div>
    </div>

    <!-- Rejected Consultants Table -->
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Rejected Applications</h3>
            <p class="text-sm text-gray-600">Consultants whose applications were rejected</p>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($rejected as $consultant)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center text-xs font-medium text-gray-600 ring-2 ring-red-500">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 max-w-xs truncate" title="{{ $consultant->admin_note ?? 'No reason provided' }}">
                                    {{ $consultant->admin_note ?? 'No reason provided' }}
                                </div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500 text-lg">No rejected consultants</p>
                                <p class="text-gray-400 text-sm">Rejected applications will appear here</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
