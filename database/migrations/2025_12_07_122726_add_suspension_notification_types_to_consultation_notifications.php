...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Update enum type to include new suspension notification types using raw SQL
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE consultation_notifications 
                       MODIFY type ENUM('reminder_24h', 'reminder_1h', 'proposal', 'status_change', 'account_welcome', 'consultant_approved', 'consultant_rejected', 'consultant_update_approved', 'consultant_update_rejected') NOT NULL");
